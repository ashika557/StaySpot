        ...
        <div className="w-72 bg-white border-r border-slate-100 h-screen sticky top-0 flex flex-col shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
            ...
            <div className="p-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-black tracking-tight text-slate-900 leading-none font-outfit uppercase">StaySpot</h1>
                        <p className="text-[10px] text-indigo-500 font-bold uppercase tracking-[0.2em] mt-1">Admin Panel</p>
                    </div>
                </div>
            </div>
                ...
                {menuItems.map((item) => {
                    ...
                    return (
                        <Link
                            key={item.id}
                            to={item.path}
                            className={`group flex items-center justify-between px-4 py-3.5 rounded-xl transition-all duration-300 font-bold text-sm ${isActive
