...
const NotificationBell = ({ user, isDark = false }) => {
  ...
  const handleNotificationClick = (notification) => {
    ...
    if (notification.notification_type === "message") {
      ...
      notification.notification_type === "rent_reminder" ||
      ...
      notification.notification_type === "complaint_status_change" ||
      notification.notification_type === "complaint_filed"
    ) {
      if (user.role === "Tenant") {
      ...
      notification.notification_type === "visit_request" ||
      notification.notification_type === "visit_status"
    ) {
      if (user.role === "Tenant") {
              ...
              notifications.map((notif) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p
                      className={`text-sm leading-tight ${!notif.is_read ? "text-gray-900 font-bold" : "text-gray-600"}`}
                    >
                      {notif.text}
                    </p>
