...
import { Home, Calendar, Users, DollarSign, MessageSquare, Eye, TrendingUp, User, Wrench, LogOut } from 'lucide-react';
        ...
        <div className="w-72 bg-white border-r border-slate-100 h-screen sticky top-0 flex flex-col shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
            <div className="p-8">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-black font-outfit tracking-tighter text-slate-900 leading-none">StaySpot</h1>
                        <p className="text-[10px] text-indigo-500 font-bold uppercase tracking-widest leading-none mt-1">Owner Hub</p>
                    </div>
                </div>
            </div>
