    ...
    <div className="w-72 bg-white border-r border-slate-100 h-screen sticky top-0 flex flex-col shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
      <div className="p-8">
        <div className="flex items-center gap-3">
          ...
          <div className="text-2xl font-black font-outfit tracking-tighter text-slate-900 leading-none">
            StaySpot
          </div>
        </div>
        <p className="text-[10px] text-indigo-500 font-bold uppercase tracking-widest mt-2 ml-1">
          Tenant Portal
        </p>
      </div>
