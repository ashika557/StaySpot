...
export default function AdminComplaintRegistry({ user }) {
  ...
  const stats = {
    ...
    critical: complaints.filter(
      (c) => c.priority === "High" || c.priority === "Priority Alpha",
    ).length,
  };
        ...
        <div className="lg:w-64 shrink-0 space-y-4">
          ...
          <div className="space-y-3 pt-4 border-t border-gray-50">
            <div className="flex items-center justify-between text-xs">
              ...
              <span
                className={`px-2.5 py-1 rounded-full text-[10px] font-semibold uppercase tracking-wider border ${getPriorityStyle(complaint.priority)}`}
              >
                {complaint.priority === "Priority Alpha"
                  ? "High"
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-gray-500">
                  Property #{complaint.room_id || "N/A"}
                </span>
              </div>
