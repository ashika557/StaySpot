...
export default function AdminDashboard({ user }) {
  ...
  const pieData = [
    {
      name: "Resolved",
      value: stats?.complaint_breakdown?.Resolved || 0,
      color: "#10B981",
    },
    {
      name: "In Progress",
      value: stats?.complaint_breakdown?.["In Progress"] || 0,
      color: "#F59E0B",
    },
    {
      name: "Pending",
      value: stats?.complaint_breakdown?.Pending || 0,
      color: "#EF4444",
    },
    ...
    <div className="max-w-[1200px] mx-auto text-left">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6 flex flex-col justify-between shadow-sm">
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-900">
                {stats?.stats?.total_rooms?.toLocaleString() || 0}
              </h3>
              <p className="text-xs font-medium text-green-500 mt-1">
                +8% from last month
              </p>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6 flex flex-col justify-between shadow-sm">
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-900">
                {stats?.stats?.total_bookings?.toLocaleString() || 0}
              </h3>
              <p className="text-xs font-medium text-green-500 mt-1">
                +15% from last month
              </p>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6 flex flex-col justify-between shadow-sm">
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-900">
                {stats?.stats?.active_complaints?.toLocaleString() || 0}
              </h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10 px-2 flex-grow">
              ...
              recentActivities.map((act, idx) => {
                ...
                return (
                  <div key={idx} className="flex items-start gap-4">
                    <div
                      className={`w-10 h-10 ${getColorClassForType(lowerType)} rounded-full flex items-center justify-center shrink-0`}
                    >
        ...
        <div className="bg-white rounded-xl bg-transparent border-0 flex flex-col h-full">
          <h2 className="text-lg font-bold text-gray-800 mb-6 px-1">
            Quick Actions
          </h2>
