    ...
    return (
      <div className="p-10 text-center bg-white rounded-xl border border-gray-100 shadow-sm max-w-2xl mx-auto mt-20">
        ...
        <p className="text-gray-500 mb-8">
          Verification cannot proceed without user data.
        </p>
        <button
          onClick={() => navigate("/admin/users")}
          className="px-6 py-2 bg-gray-900 text-white font-semibold rounded-lg hover:bg-gray-800 transition-all"
        >
          Go Back
        </button>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-8">
        ...
        <div className="p-8 flex flex-col gap-8">
          ...
          <div className="space-y-4">
            ...
            {user.identity_document ? (
              <div
                className="rounded-2xl overflow-hidden border border-gray-100 bg-gray-50 p-2 aspect-video flex items-center justify-center shadow-inner relative group cursor-zoom-in"
                onClick={() =>
                  window.open(getMediaUrl(user.identity_document), "_blank")
                }
              >
                <img
          ...
          <div className="pt-4">
            ...
            user.identity_document ? (
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-500">
                    Approve or reject this identification after reviewing the
                    image above.
                  </p>
                </div>
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl flex items-center justify-center shadow-sm bg-white ${
                    user.is_identity_verified
                      ? "text-emerald-600"
                      : user.verification_status === "Rejected"
                        ? "text-rose-600"
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {user.is_identity_verified
                      ...
                      : user.verification_status === "Rejected"
                        ? "User must re-submit documentary."
...
function StatusBadge({ status, verified }) {
  ...
  return (
    <span
      className={`px-3 py-1 text-[9px] font-bold uppercase tracking-widest rounded-full border flex items-center gap-1.5 ${configs[status] || "bg-gray-50 text-gray-500 border-gray-100"}`}
    >
