    ...
    return (
      <div className="p-10 text-center bg-white rounded-[3rem] border border-red-100 shadow-sm max-w-2xl mx-auto mt-20">
        ...
        <p className="text-gray-500 mb-8 font-medium">
          The listing you are looking for might have been removed or the ID is
          incorrect.
        </p>
        <button
            ...
            <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm p-10">
              ...
              <div className="space-y-6 pt-2">
                <div className="flex items-center justify-between group">
                  <span className="text-xs font-black text-gray-400 uppercase tracking-widest group-hover:text-blue-500 transition-colors">
                    Floor Level
                  </span>
                ...
                <div className="flex items-center justify-between group">
                  ...
                  <span
                    className={`flex items-center gap-1.5 font-bold ${room.wifi ? "text-emerald-600" : "text-gray-400"}`}
                  >
                ...
                <div className="flex items-center justify-between group">
                  ...
                  <span
                    className={`flex items-center gap-1.5 font-bold ${room.ac ? "text-emerald-600" : "text-gray-400"}`}
                  >
                ...
                <div className="flex items-center justify-between group">
                  ...
                  <span
                    className={`flex items-center gap-1.5 font-bold ${room.tv ? "text-emerald-600" : "text-gray-400"}`}
                  >
              ...
              <div className="flex-1 flex flex-col items-center justify-center py-6">
                ...
                <div className="space-y-4 w-full px-6">
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <code className="bg-gray-50 px-3 py-1 rounded-lg text-blue-600 font-bold">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div className="p-10 text-center">
              ...
              <h4 className="text-xl font-black text-gray-900 tracking-tight mb-2 truncate">
