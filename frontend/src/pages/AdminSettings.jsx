            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                <div>
                    ...
                    <p className="text-gray-500 font-medium ml-1">
                        Configure system settings, security rules and notifications.
                    </p>
                </div>

                {/* Button to save settings (backend connection can be added later) */}
                ...
                <div className="xl:col-span-2 space-y-8">
                    ...
                    <section className="bg-white rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-gray-100 p-10">
                        ...
                        <div className="space-y-6">
                            <ToggleItem
                                label="Mandatory Identity Verification"
                                description="Require tenants to verify ID before booking"
                                enabled={true}
                            />
                            <ToggleItem
                                label="Auto-moderate Listings"
                                description="Automatically flag suspicious property images"
                                enabled={false}
                            />
                            <ToggleItem
                                label="Two-Factor Authentication"
                                description="Enable extra security for admin accounts"
                                enabled={true}
                            />
                        </div>
                    </section>
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-gradient-to-br from-gray-900 to-black rounded-[2.5rem] p-10 text-white shadow-2xl">
                        ...
                        <p className="text-gray-400 font-medium text-sm leading-relaxed mb-8">
                            Platform is currently running on
                            <span className="text-white font-bold"> Node v18.16.0</span>.
                        </p>
...
/* Toggle Switch Component used for security settings */
        ...
        <div className="flex items-center justify-between p-6 bg-gray-50/50 rounded-3xl border border-transparent hover:border-gray-100 transition-all text-left">
            ...
            <button
                className={`w-14 h-8 rounded-full transition-all relative ${
                    enabled ? 'bg-blue-600 shadow-lg shadow-blue-100' : 'bg-gray-200'
                }`}
            >
                <div
