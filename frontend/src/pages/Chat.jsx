...
const Chat = ({ user }) => {
  ...
  const handleAutoStartChat = React.useCallback(
    async (userId) => {
    ...
    <div className="flex bg-gray-50 min-h-screen">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4">
        <div className="bg-white w-full max-w-6xl h-[75vh] rounded-2xl shadow-xl overflow-hidden flex transition-all duration-300">
          ...
          <div
            className={`w-full md:w-1/3 bg-white border-r border-gray-100 flex flex-col ${activeChat ? "hidden md:flex" : "flex"}`}
          >
                  ...
                  >
                    <div className="w-12 h-12 rounded-full bg-gradient-to-tr from-blue-100 to-indigo-100 flex items-center justify-center text-indigo-700 font-bold border-2 border-white shadow-sm overflow-hidden">
                      {conv.other_user.profile_photo ? (
                        <img
                          src={getMediaUrl(conv.other_user.profile_photo)}
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between items-baseline">
                        <h3 className="text-sm font-bold truncate text-gray-800">
          ...
          <div
            className={`w-full md:w-2/3 bg-white flex flex-col ${!activeChat ? "hidden md:flex" : "flex"}`}
          >
            {activeChat ? (
              <>
                {/* chat header */}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-700 font-bold overflow-hidden">
                      {activeChat.other_user.profile_photo ? (
                        <img
                          src={getMediaUrl(activeChat.other_user.profile_photo)}
                ...
                <div
                  ...
                  className="flex-1 overflow-y-auto p-4 bg-gray-50/50 custom-scrollbar space-y-4"
                >
                  {messages.map((msg, index) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`max-w-[75%] rounded-2xl p-3 shadow-sm relative group ${isMe ? "bg-blue-600 text-white rounded-br-none" : "bg-white text-gray-800 rounded-bl-none border border-gray-100"}`}
                        >
                          {msg.text && (
                          ...
                          {msg.image && (
                            <div className="mt-2 rounded-lg overflow-hidden border border-white/20">
                              <img
                                ...
                                onClick={() =>
                                  window.open(getMediaUrl(msg.image), "_blank")
                                }
                              />
                            </div>
                          )}
                          ...
                          {msg.file && (
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className={`mt-2 flex items-center gap-2 p-2 rounded-lg transition-colors ${isMe ? "bg-blue-700 hover:bg-blue-800" : "bg-gray-100 hover:bg-gray-200"}`}
                            >
                          ...
                          <div
                            className={`text-[10px] mt-1.5 flex items-center justify-end gap-1.5 ${isMe ? "text-blue-100" : "text-gray-400"}`}
                          >
                            <span>
                ...
                >
                  ...
                  <button
                    ...
                    disabled={uploading}
                    className="p-2.5 text-gray-400 hover:bg-gray-100 hover:text-blue-600 rounded-full transition-all"
                  >
                    {uploading ? (
              ...
              <div className="flex-1 flex flex-col items-center justify-center bg-gray-50 text-gray-400">
                ...
                <p className="max-w-xs text-center text-sm mt-3 leading-relaxed text-gray-500">
                  Connect with owners or tenants to discuss room details and
                  bookings.
                </p>
              </div>
            )}
