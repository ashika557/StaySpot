    ...
    <div className="min-h-screen flex items-center justify-center bg-blue-50 font-sans p-5">
      <div className="flex w-full max-w-[940px] rounded-2xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.12)] min-h-[580px] bg-white">
        ...
        <div className="w-[42%] hidden md:flex flex-col justify-between p-12 relative overflow-hidden bg-indigo-600">
          ...
          <div className="z-10 mt-auto">
            ...
            <h1 className="text-white text-5xl font-extrabold leading-[1.1] mb-5 tracking-tight font-sans">
              {step === 'input' ? <>Forgot Your<br />Password?</> : <>Check Your<br />Inbox</>}
            </h1>
        ...
        <div className="flex-1 bg-white p-8 md:p-12 flex flex-col justify-center overflow-y-auto">
          ...
          {step === 'input' && (
            <div>
              <h2 className="text-2xl font-extrabold text-gray-900 mb-1 tracking-tight">Reset Password</h2>
              <p className="text-sm text-gray-500 mb-6">Enter your Gmail address to receive a reset code</p>
          ...
          {step === 'otp' && (
            <div>
              ...
              <p className="text-sm text-gray-500 mb-6">
                We sent a 6-digit code to <strong className="text-gray-800 font-bold">{email}</strong>
              </p>
              ...
              <form onSubmit={handleVerifyOtp} className="flex flex-col gap-4">
                <div className="mb-2">
                  <label className="block text-xs font-extrabold text-[#8792a6] mb-2 uppercase tracking-wider">Verification Code</label>
                  <input
                    type="text"
                    maxLength="6"
                    value={otp}
                ...
                <div className="mt-4">
                  ...
                  <button
                    type="button"
                    onClick={() => { setStep('input'); setOtp(''); setMessage({ type: '', text: '' }); }}
