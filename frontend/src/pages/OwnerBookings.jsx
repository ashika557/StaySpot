...
const OwnerBookings = ({ user, onLogout }) => {
  ...
  const stats = {
    ...
    approved: bookings.filter((b) => ["Confirmed", "Active"].includes(b.status))
      .length,
  ...
  const pendingRequests = filteredBookings.filter(
    (b) => b.status === "Pending",
  );
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-8">
            <div>
              ...
              <p className="text-sm text-gray-400 mt-0.5">
                Manage room booking requests from tenants
              </p>
            </div>
            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                >
                  ...
                  {[...new Set(bookings.map((b) => b.room.title))].map(
                    (title) => (
            ...
            <div className="px-6 py-4 border-b border-gray-50 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">
                  All bookings and their current status
                </p>
              </div>
    ...
    <div className="p-5">
          ...
          <img
            src={
              booking.tenant.profile_photo
                ? getMediaUrl(booking.tenant.profile_photo)
                : `https://ui-avatars.com/api/?name=${booking.tenant.full_name}&background=4f46e5&color=fff&bold=true`
            }
      ...
      <div className="bg-gray-50 p-4 rounded-xl border border-gray-100 space-y-3 mb-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <span
            className={`text-[10px] font-bold px-2 py-0.5 rounded-lg ${booking.tenant.is_identity_verified ? "bg-emerald-50 text-emerald-600" : "bg-rose-50 text-rose-500"}`}
          >
      ...
      <div className="flex items-center gap-4 w-64">
        <img
          src={
            booking.tenant.profile_photo
              ? getMediaUrl(booking.tenant.profile_photo)
              : `https://ui-avatars.com/api/?name=${booking.tenant.full_name}&background=f3f4f6&color=94a3b8&bold=true`
          }
