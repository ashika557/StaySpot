    ...
    try {
      ...
      if (response.ok) {
        ...
        const pending = data.logs.filter(
          (log) => log.status === "Pending" || log.status === "Overdue",
        );
  ...
  const getRoomData = React.useCallback(async () => {
    try {
      ...
      if (response.ok) {
        ...
        setOccupiedRooms(
          rooms.filter((r) => r.status === "Occupied" || r.status === "Rented")
            .length,
        );
      }
    } catch (error) {
        ...
        <main className="p-8">
          ...
          <div className="mb-8 flex items-start justify-between">
            <div>
              ...
              <p className="text-sm text-gray-400 mt-0.5">
                Here's an overview of your properties today.
              </p>
            </div>
            <button
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            {[
              ...
              >
                <div
                  className={`w-9 h-9 rounded-lg flex items-center justify-center mb-4 ${stat.iconBg}`}
                >
            ...
            <div className="col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-50 flex items-center justify-between">
                  ...
                  <button
                    onClick={() => navigate(ROUTES.OWNER_PAYMENTS)}
                    ...
                    <tbody className="divide-y divide-gray-50">
                      {pendingPayments.length > 0 ? (
                        pendingPayments.map((p) => (
                          ...
                          >
                              ...
                              <div className="flex items-center gap-3">
                                <img
                                  src={
                                    ...
                                    `https://ui-avatars.com/api/?name=${p.tenant.full_name}&background=eff6ff&color=2563eb&bold=true`
                                  }
                            ...
                            <td className="px-6 py-4 text-right">
                              <button
                                onClick={() =>
                                  handleSendReminder(p.booking_id || p.id)
                                }
                        ...
                        <tr>
                          <td
                            colSpan="2"
                            className="px-6 py-8 text-center text-[10px] text-gray-400 italic"
                          >
