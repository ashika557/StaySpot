...
function Profile({ user, onUpdateUser, refreshUser }) {
    ...
    const avatarSrc = profilePreview
        || (user?.profile_photo ? getMediaUrl(user.profile_photo) : `https://ui-avatars.com/api/?name=${user?.full_name || 'User'}&background=f3f4f6&color=9ca3af&size=120`);
        ...
        <div className="flex h-screen bg-gray-50 overflow-hidden font-inter">
            ...
            <div className="flex-1 flex flex-col overflow-auto">
                <div className="p-8 max-w-4xl mx-auto w-full">
                    ...
                    {/* Header */}
                    <div className="mb-8">
                        <h1 className="text-2xl font-bold text-gray-900">{isOwner ? 'Owner Profile' : 'My Profile'}</h1>
                        <p className="text-sm text-gray-400 mt-0.5">Manage your account information and settings</p>
                    </div>

                    {/* Alert */}
                    {message.text && (
                        <div className={`px-4 py-3 rounded-lg text-sm mb-6 font-medium border flex items-center gap-2 ${message.type === 'success'
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                            <h3 className="text-sm font-bold text-gray-900 mb-5">Profile Photo</h3>
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-gray-400 mt-1.5">JPG, PNG or GIF. Max 2MB</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                            <h3 className="text-sm font-bold text-gray-900 mb-5">Personal Details</h3>
                            ...
                            <div className="flex justify-end pt-5 mt-5 border-t border-gray-50">
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className={`px-6 py-2.5 text-sm font-bold text-white rounded-lg transition-all flex items-center gap-2 shadow-sm ${loading
                        ...
                        <div className="bg-white rounded-xl border border-gray-100 shadow-sm px-6 py-4 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-xs font-bold text-gray-700">Account Role</p>
                            ...
                            <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden animate-in zoom-in-95 duration-200">
                                <div className="p-6">
                                    ...
                                    <p className="text-sm text-gray-500 leading-relaxed">
                                        Are you absolutely sure you want to delete your account? This action is **permanent** and will remove all your data, rooms, and bookings from our system.
                                    </p>
                                </div>
