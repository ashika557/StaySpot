    ...
    if (verificationStatus === "Approved") {
      return (
        <div className="bg-emerald-50 border border-emerald-100 rounded-[2rem] p-8 mb-8 text-center animate-in zoom-in duration-500">
          ...
          <h3 className="text-2xl font-black text-emerald-900 font-outfit tracking-tight">
            Verified
          </h3>
    ...
    if (verificationStatus === "Pending") {
      return (
        <div className="bg-amber-50 border border-amber-100 rounded-[2rem] p-8 mb-8 text-center animate-pulse">
          ...
          <h3 className="text-xl font-black text-amber-900 font-outfit tracking-tight">
            Pending Review
          </h3>
          <p className="text-amber-700 text-sm font-medium mt-2">
            We are reviewing your document. This usually takes about 24 hours.
          </p>
        </div>
      );
    }
        ...
        <div className="bg-rose-50 border border-rose-100 rounded-[2rem] p-8 mb-8">
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              <h3 className="text-xl font-black text-rose-900 font-outfit tracking-tight uppercase">
              ...
              <p className="text-rose-600 text-xs font-medium mt-4">
                Please upload a clear photo of your ID to try again.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-[3rem] shadow-[0_32px_120px_-20px_rgba(0,0,0,0.08)] max-w-lg w-full overflow-hidden border border-slate-100 relative z-10 fade-in text-slate-900">
        ...
        <div className="bg-indigo-600 p-10 text-white text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-3xl font-black font-outfit tracking-tighter uppercase">
              Identity Verification
            </h1>
            <p className="text-indigo-300 text-[10px] font-black uppercase tracking-[0.3em] mt-2">
        ...
        <div className="p-10 text-slate-900">
          ...
          {status === "success" ? (
            <div className="text-center py-10 animate-in fade-in zoom-in-95 duration-500">
              ...
              <h3 className="text-3xl font-black text-slate-900 font-outfit tracking-tighter mb-3">
                Thank You
              </h3>
              <p className="text-slate-500 font-medium mb-10 leading-relaxed px-4">
                Your document has been submitted successfully and is currently
              ...
              <button
                ...
                className="text-indigo-600 text-[10px] font-black uppercase tracking-[0.2em] hover:text-indigo-700 transition-colors flex items-center justify-center gap-2 mx-auto"
              >
              ...
              <div className="space-y-2">
                ...
                <div className="relative group opacity-60">
                  ...
                  <input
                    ...
                    value={user?.email || ""}
                    disabled
                    className="w-full py-4 pl-12 pr-4 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-bold text-slate-400 cursor-not-allowed"
                  />
                </div>
              </div>
                  ...
                  {preview ? (
                    <div className="relative group/preview animate-in fade-in duration-500">
                      ...
                      <img
                        src={preview}
                        alt="ID Preview"
                        className="h-48 w-full object-cover rounded-2xl shadow-xl brightness-95"
                      />
                    </div>
                  ) : (
                    <div className="py-6 space-y-4">
                      ...
                      <div>
                        <p className="text-sm font-black text-slate-900 font-outfit">
                          Select File
                        </p>
